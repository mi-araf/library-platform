            ...
            <div className="pt-26 pb-18 px-5">
                <div className="mx-auto flex min-h-[calc(100vh-8rem)] max-w-7xl items-center justify-center">
                    <div className="w-full max-w-md rounded-[2rem] border border-white/70 bg-white/80 p-6 shadow-2xl shadow-amber-900/10 backdrop-blur-xl sm:p-8">
                        <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-pink-400/70 text-2xl text-white shadow-lg shadow-orange-600/20">
                            <UserKey />
                        </div>
                        ...
                        <div className="mt-5 text-center">
                            ...
                            <p className="mt-2 text-sm font-medium text-neutral/50">
                                Welcome Back to your <span className="bg-linear-to-r from-primary via-fuchsia-400 to-orange-500 bg-clip-text text-transparent ">Araf&apos;</span> Library.
                            </p>
                        </div>
                        ...
                        <form className="mt-8 space-y-4" onSubmit={onSubmit}>
                            ...
                            <button type="submit" className="w-full rounded-full bg-orange-500/60 px-6 py-3 text-sm font-black text-white shadow-lg shadow-blue-500/20 transition duration-300 hover:-translate-y-1 hover:bg-red-500/70 hover:shadow-xl hover:shadow-primary/25 active:scale-95 cursor-pointer" >
                                Sign In
                            </button>
                        </form>
